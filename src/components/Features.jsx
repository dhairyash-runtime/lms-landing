    ...
    return (
        <section className="w-full font-['Poppins'] bg-white flex flex-col items-center pt-14 pb-0 md:pt-24 md:pb-0 px-5 md:px-6">
            ...
            <p className="text-center text-[#4C4C4C] max-w-[400px] mt-4 md:mt-6 max-w-[320px] md:max-w-lg text-[15px] md:text-[20px] leading-[1.65] md:px-0">
                End-to-end learning management solutions — from digital schools to corporate training — powered by modern, scalable architecture.
            </p>
                        ...
                        >
                            <div className="w-full h-full p-4">
                                <div className="flex items-center gap-3 mb-4 border-b pb-3">
                                    <span className="text-[#FF4D00] font-bold text-lg">Runtime</span>
                                    <span className="text-gray-600 text-sm font-medium">LMS</span>
                                ...
                                <div className="flex gap-4">
                                    <div className="w-40 bg-gray-900 rounded-lg p-3 text-white text-xs space-y-2 shrink-0">
                                        ...
                                        <div className="bg-white/20 rounded px-2 py-1">Students</div>
                                        <div className="text-gray-400">Exams</div>
                                    </div>
                                    <div className="flex-1 text-xs text-gray-600 space-y-2">
                                        <div className="font-semibold text-sm text-gray-800 mb-2">Course Catalog</div>
                                        <div className="grid grid-cols-3 gap-2">
                                            {['Video Lessons', 'Assignments', 'Study Materials', 'Live Classes', 'Certifications', 'Webinars'].map(name => (
                                                <div key={name} className="bg-gray-50 border rounded p-2">
                                                    <div className="font-medium text-gray-700 truncate">{name}</div>
                                                    <div className="flex gap-1 mt-1">
                                                        <span className="bg-blue-100 text-blue-600 text-[10px] px-1 rounded">LEARN</span>
                                                    </div>
                                                </div>
                                            ))}
                                        </div>
